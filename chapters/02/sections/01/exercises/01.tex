...
\AxiomC{\(\Gamma, v_n : \sigma, \Delta, v_{n+m} : \rho, \Theta \vdash M : \tau\)}
\RightLabel{\ref{lemma:ex:2.1.1:1.a}}
\UnaryInfC{\(\Gamma, \Delta, v_{n+m-1} : \rho, v_{n+m} : \sigma, \Theta \vdash M\left[\sfrac{v_n}{v_{n+m}},\sfrac{v_{n+1}}{v_n},\ldots,\sfrac{v_{n+m}}{v_{n+m-1}}\right] : \tau\)}
\RightLabel{\ref{lemma:ex:2.1.1:1.b}}
\UnaryInfC{\(\Gamma, v_n : \rho, \Delta, v_{n+m} : \sigma, \Theta \vdash M\left[\sfrac{v_n}{v_{n+m}},\sfrac{v_{n+m}}{v_n}\right] : \tau\)}
\end{prooftree}
